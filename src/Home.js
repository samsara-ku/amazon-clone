      ...
      <div className="home__container">
        ...
        <div className="home__row">
          ...
          <Product
            ...
            price={239.9}
            image={
              'https://images-na.ssl-images-amazon.com/images/I/61etD4-IrPL._AC_SX450_.jpg'
            }
            rating={4}
          />
        </div>
        <div className="home__row">
          <Product
            ...
            price={12.9}
            image={
              'https://m.media-amazon.com/images/I/71+eIQhzIVL._AC_SS350_.jpg'
            }
            rating={3}
          />
          <Product
        ...
        <div className="home__row">
          <Product
            ...
            price={1099.99}
            image={
              'https://images-na.ssl-images-amazon.com/images/I/6125mFrzr6L._AC_SL1000_.jpg'
            }
            rating={3}
          />
        </div>
